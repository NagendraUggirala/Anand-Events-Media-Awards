...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative py-16 md:py-24 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          >
            ...
            >
              <div className="inline-block bg-white/10 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-white/20 shadow-2xl">
                {/* Sanskrit Text */}
                <div className="text-4xl md:text-6xl font-bold text-yellow-300 mb-6 font-sans leading-tight">
                  धर्मो रक्षति रक्षितः
                </div>
                
                {/* Transliteration */}
                <div className="text-xl md:text-3xl text-blue-100 italic mb-6">
                  "Dharmo Rakshati Rakshitah"
                </div>
                
                {/* Separator */}
                <div className="w-20 h-1 bg-gradient-to-r from-yellow-400 to-orange-400 mx-auto rounded-full mb-6"></div>
                
                {/* Meaning */}
                <div className="text-lg md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-blue-100 leading-relaxed px-4">
            ...
            <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-start">
              ...
              >
                <div className="relative group w-full max-w-sm md:max-w-md lg:max-w-lg">
                  ...
                  <div className="w-full h-[400px] md:h-[500px] lg:h-[580px] rounded-2xl overflow-hidden shadow-2xl ring-1 ring-gray-100 bg-white transform transition-all duration-500 group-hover:shadow-3xl group-hover:scale-[1.02] group-hover:ring-2 group-hover:ring-orange-200">
                    <img
                  ...
                  >
                    <div className="bg-gradient-to-r from-blue-50/50 to-orange-50/50 rounded-xl p-4 md:p-6 border-l-4 border-orange-500 shadow-lg transition-all duration-300 group-hover:shadow-xl group-hover:border-orange-600">
              ...
              >
                <div>
                  <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 text-center lg:text-left">Anand</h2>
                  <p className="text-lg md:text-xl text-orange-500 font-semibold mt-1 text-center lg:text-left">Founder & Chairman</p>

                  <div className="mt-4 md:mt-6 text-gray-700 space-y-4 max-w-xl mx-auto lg:mx-0">
                    ...
                    <div className="bg-blue-50 rounded-lg p-4 md:p-6 mt-4 border-l-4 border-blue-500">
                      <h4 className="font-bold text-blue-800 text-lg md:text-xl mb-2">About Anand Realtyy</h4>
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-stretch">
              <motion.div variants={itemVariants} className="flex">
                <div className="bg-gradient-to-br from-blue-50 to-white p-6 md:p-8 rounded-2xl shadow-lg border border-blue-100 hover:shadow-xl hover:border-blue-200 transition-all duration-300 flex flex-col h-full w-full">
                  <div className="flex flex-col h-full justify-between">
                    <div>
                      <h3 className="text-xl md:text-2xl font-bold text-blue-800 mb-4 md:mb-6 text-left">
              ...
              <motion.div variants={itemVariants} className="flex">
                <div className="bg-gradient-to-br from-orange-50 to-white p-6 md:p-8 rounded-2xl shadow-lg border border-orange-100 hover:shadow-xl hover:border-orange-200 transition-all duration-300 flex flex-col h-full w-full">
                  <div className="flex flex-col h-full justify-between">
                    <div>
                      <h3 className="text-xl md:text-2xl font-bold text-blue-800 mb-4 md:mb-6 text-left">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 max-w-6xl mx-auto">
            {values.map((value, index) => (
              ...
              >
                ...
                <h3 className="text-lg md:text-xl font-bold text-blue-800 mb-2 md:mb-3 group-hover:text-blue-600 transition-colors">{value.title}</h3>
                <p className="text-gray-600 text-xs md:text-sm leading-relaxed group-hover:text-gray-700 transition-colors">{value.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      {/* Business Verticals - Mobile Optimized */}
      <section ref={ref2} className="py-12 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6">
          <motion.div
            variants={containerVariants}
            initial="hidden"
          ...
          >
            <motion.div variants={itemVariants} className="text-center mb-12 md:mb-16">
              ...
              <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto px-4">
                Diverse sectors united by common values and commitment to excellence
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              {sectors.map((sector, index) => (
                <motion.div
                  ...
                  className={`bg-gradient-to-br ${sector.color} text-white rounded-2xl shadow-xl overflow-hidden group hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-white/30`}
                >
                  <div className="p-6 md:p-8">
                    <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 group-hover:scale-105 transition-transform duration-300">{sector.title}</h3>
                    <p className="text-blue-100 mb-4 md:mb-6 leading-relaxed group-hover:text-white transition-colors text-sm md:text-base">{sector.description}</p>
                    <div className="flex justify-between items-center">
                      <span className="text-orange-200 font-semibold text-sm md:text-base group-hover:text-orange-100 transition-colors">{sector.stats}</span>
                      <div className="w-8 h-8 md:w-10 md:h-10 bg-white/20 rounded-full flex items-center justify-center group-hover:bg-white/30 group-hover:scale-110 transition-all duration-300">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="md:hidden space-y-8">
              {milestones.map((milestone, index) => (
                ...
                >
                  {/* Year Circle */}
                  <div className="w-20 h-20 bg-gradient-to-br from-orange-500 to-orange-600 rounded-full flex items-center justify-center text-white font-bold text-lg mb-4 shadow-lg hover:scale-110 hover:shadow-xl transition-all duration-300">
                    {milestone.year}
                  </div>
                  
                  {/* Content Card */}
                  <div className="bg-white p-6 rounded-2xl shadow-lg border border-blue-100 w-full text-center hover:shadow-xl hover:border-blue-200 transition-all duration-300 group">
                  ...
                  {index < milestones.length - 1 && (
                    <div className="w-1 h-8 bg-blue-200 mt-4 rounded-full"></div>
                  )}
                </motion.div>
              ))}
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            <motion.div variants={itemVariants}>
              ...
              <p className="text-lg md:text-xl text-gray-700 leading-relaxed mb-6 md:mb-8 px-4">
              ...
              >
                <Link
                  to="/contact"
                  className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-3 md:px-8 md:py-4 rounded-lg font-semibold shadow-lg hover:shadow-xl hover:from-orange-600 hover:to-orange-700 transition-all duration-300 text-sm md:text-base"
                >
                  Join Our Journey
                </Link>
              </motion.div>
        ...
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
              <Link
                to="/projects"
                className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-2 md:px-8 md:py-3 rounded-lg font-semibold transition-all duration-300 hover:shadow-lg hover:scale-105 text-sm md:text-base"
              >
                Explore Properties
              </Link>
              <Link
                to="/contact"
                className="border-2 border-white text-white hover:bg-white hover:text-blue-800 px-6 py-2 md:px-8 md:py-3 rounded-lg font-semibold transition-all duration-300 hover:shadow-lg hover:scale-105 text-sm md:text-base"
              >
                Get In Touch
              </Link>
            </div>
...
function EnhancedStatCard({ title, subtitle, delay = 0 }) {
  return (
    <motion.div
      ...
      className="group"
    >
      <div className="bg-white rounded-xl shadow-lg p-4 md:p-5 flex flex-col items-start justify-center ring-1 ring-gray-100 hover:ring-2 hover:ring-orange-200 hover:shadow-xl transition-all duration-300">
        ...
        <div className="text-xs md:text-sm text-gray-400 mt-1 group-hover:text-gray-600 transition-colors duration-300">
          {subtitle}
        </div>
