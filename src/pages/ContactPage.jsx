...
const ContactAdvancedWithMapBottom = () => {
  ...
  const handleFormChange = (values) => {
    const t = setTimeout(() => {
      try {
        localStorage.setItem("anand_contact_draft", JSON.stringify(values));
      } catch {
        /* ignore */
      }
    }, 600);
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-12 bg-gradient-to-br from-blue-500 via-violet-500 to-blue-600 overflow-hidden">
